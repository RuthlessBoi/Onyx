...
using System.Linq;
using static Onyx.Binding.BoundNodeFactory;
...
namespace Onyx
{
    internal sealed class Lowerer : BoundTreeRewriter
    {
        ...
        private static bool CanFallThrough(BoundStatement boundStatement) => boundStatement.Type != BoundNodeType.ReturnStatement && boundStatement.Type != BoundNodeType.GotoStatement;
